...
<body>
	...
	<div class="container">
		...
		<div class="regisFrm">
			...
			<p><a href="proyecto/index.html">Seguir</a></p>
		</div>

		</div>
        <?php }else{ ?>
		<a align="center"><h2><font  color="green",size=7> Inicio de sesión</h2></a>
		...
		<div class="regisFrm">
            ...
            <p>¿No tienes cuenta aún? <a href="registration.php">Regístrate</a></p>
		</div>
        <?php } ?>
	</div>
</body>
